...
```{r, class.source="codeblock",eval=FALSE, fig.width=7, fig.height=7}
plot(x = PC$PC1,
     y = PC$PC2,
     pch = 19,
     xlab="PC1",
...
```{r, class.source="codeblock",eval=FALSE}
mouse_tsne10 = tsne(mouse_exp,perplexity = 10)
mouse_tsne20 = tsne(mouse_exp,perplexity = 20)
mouse_tsne50 = tsne(mouse_exp,perplexity = 50)
mouse_tsne100 = tsne(mouse_exp,perplexity = 100)
```


```{r, fig.width=7, fig.height=7, class.source="codeblock",eval=FALSE}
par(mfrow=c(2,2))
plot(mouse_tsne10[,1],
     mouse_tsne10[,2],
     main = "Perplexity = 10",
