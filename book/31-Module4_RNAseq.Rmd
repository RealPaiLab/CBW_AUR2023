...
1. Create a new `DGEList` object with your filtered genes
2. Filter genes with CPM > 25 in at least two samples
3. Normalize and plot your data
4. Perform differential gene expression analysis on wild-type vs. mutant yeast samples
5. How many significantly up-regulated genes are there at the 5% FDR level? How many significantly down-regulated genes? How many in total?
6. Create a volcano plot
7. Bonus: Create a histogram of p-values. Is there a signal?
